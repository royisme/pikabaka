...
First off, thank you for considering contributing to Pika! It's people like you that make Pika such a great tool.
...
This project and everyone participating in it is governed by the [Pika Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior via GitHub Issues.
...
- Explain why this enhancement would be useful to most Pika users.
...
2. Clone your fork locally: `git clone https://github.com/YOUR_USERNAME/pika.git`
...
Pika uses a modern stack consisting of:
