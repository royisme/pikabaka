                                ...
                                <div className="max-w-4xl mx-auto space-y-6">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            <h1 className="text-3xl font-celeb-light font-medium text-text-primary tracking-wide drop-shadow-sm">My Pika</h1>
                                        ...
                                        <motion.button
                                            onClick={() => {
                                                if (isMeetingActive) {
                                                    ...
                                                    // the Pika app or steal OS focus — preserves stealth.
                                                ...
                                                <AnimatePresence mode="wait" initial={false}>
                                                    {isMeetingActive ? (
                                                        ...
                                                        <motion.div
                                                            ...
                                                            className="flex items-center gap-3"
                                                        >
                                                            <img src={icon} alt="Logo" className="w-[18px] h-[18px] object-contain drop-shadow-[0_1px_2px_rgba(0,0,0,0.12)] opacity-90" />
                                                            <span className="drop-shadow-[0_1px_1px_rgba(0,0,0,0.1)] text-[20px] leading-none">Start Pika</span>
                                                        </motion.div>
                                                    )}
                                                </AnimatePresence>
                                            </div>
                                    ...
                                    {showUpcomingHero && (
                                        <div className="grid grid-cols-1 gap-3">
                                            {isPrepared && preparedEvent ? (
                                                ...
                                                <div className={`relative group rounded-xl overflow-hidden ${isLight ? 'bg-bg-elevated' : 'bg-bg-secondary'} flex flex-col shadow-[0_1px_3px_rgba(0,0,0,0.07),0_1px_2px_rgba(0,0,0,0.04)]`}>
