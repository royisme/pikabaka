            ...
            <AnimatePresence>
                {isExpanded && (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="px-4 pt-2 pb-1 no-drag" aria-live="polite" aria-atomic="true">
                                <div className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[10px] border border-border-subtle ${subtleSurfaceClass} ${sttStatus.toneClass}`} style={appearance.subtleStyle}>
                    ...
                    `}>
                            ...
                            <div className={`flex flex-nowrap justify-center items-center gap-1.5 px-4 pb-3 overflow-x-hidden ${(transcriptSegments.length > 0 || isInterviewerSpeaking) && showTranscript ? 'pt-1' : 'pt-3'}`}>
