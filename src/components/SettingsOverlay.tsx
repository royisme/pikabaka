...
const SettingsOverlay: React.FC<SettingsOverlayProps> = ({ isOpen, onClose, initialTab = 'general' }) => {
    ...
    const { mutate: researchCompany, isLoading: companyResearching, data: companyResearchResult } = useCompanyResearch();
    const { generate: generateNegotiation, script: negotiationScript, isGenerating: negotiationGenerating, error: negotiationErrorState } = useNegotiationScript();
    ...
    const jdUploading = uploadJD.isLoading;
    const jdError = uploadJD.error instanceof Error ? uploadJD.error.message : '';
    const companyDossier = companyResearchResult?.dossier ?? profileData?.companyDossier ?? null;
    const negotiationError = negotiationErrorState?.message || '';
                                                ...
                                                <div className="flex items-center gap-2 shrink-0">
                                                    ...
                                                    <button
                                                        onClick={async () => {
                                                            const fileResult = await window.electronAPI?.profileSelectFile?.();
                                                            if (fileResult?.filePath) {
                                                                uploadJD.mutate(fileResult.filePath);
                                                            }
                                                        }}
                                            ...
                                            <div className="bg-bg-item-surface rounded-xl border border-border-subtle p-5">
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            if (profileData.activeJD?.company) {
                                                                researchCompany(profileData.activeJD.company);
                                                            }
                                                        }}
                                                ...
                                                {companyDossier && (
                                                    <div className="space-y-4 border-t border-border-subtle pt-4 mt-2">
                                                        ...
                                                        {/* Salary Estimates */}
                                                        {(companyDossier.salary_estimates?.length ?? 0) > 0 && (
                                                            <div>
                                                                ...
                                                                <div className="bg-bg-input p-3 rounded-lg">
                                                                    ...
                                                                    <div className="flex items-center justify-between mb-3 pb-3 border-b border-border-subtle">
                                                                        ...
                                                                        <div className="text-right">
                                                                            ...
                                                                            {(companyDossier.culture_ratings.data_sources?.length ?? 0) > 0 && (
                                                        ...
                                                        {/* Employee Reviews */}
                                                        {(companyDossier.employee_reviews?.length ?? 0) > 0 && (
                                                            <div>
                                                        ...
                                                        {(companyDossier.critics?.length ?? 0) > 0 && (
                                                            <div>
                                                        ...
                                                        {/* Benefits */}
                                                        {(companyDossier.benefits?.length ?? 0) > 0 && (
                                                            <div>
                                                                <div className="flex items-center gap-1.5 mb-2">
                                                        ...
                                                        {/* Core Values */}
                                                        {(companyDossier.core_values?.length ?? 0) > 0 && (
                                                            <div>
                                                        ...
                                                        {/* Competitors */}
                                                        {(companyDossier.competitors?.length ?? 0) > 0 && (
                                                            <div>
                                                        ...
                                                        {/* Sources count */}
                                                        {(companyDossier.sources?.length ?? 0) > 0 && (
                                                ...
                                                <div className="p-5">
                                                    ...
                                                    {negotiationScript && !negotiationGenerating && (
                                                        <div className="space-y-3">
                                                                ...
                                                                <div className="rounded-xl p-4 flex items-center justify-between" style={{ background: 'linear-gradient(135deg, rgba(16,185,129,0.08) 0%, rgba(6,182,212,0.06) 100%)', border: '1px solid rgba(16,185,129,0.18)' }}>
                                                                    <div>
                                                                        ...
                                                                        <div className="text-xl font-bold tracking-tight" style={{ color: '#34d399' }}>
                                                                            {negotiationScript.salary_range.currency} {(negotiationScript.salary_range.min ?? negotiationScript.salary_range.low).toLocaleString()}
                                                                            <span className="text-text-tertiary font-normal mx-2">–</span>
                                                                            {(negotiationScript.salary_range.max ?? negotiationScript.salary_range.high).toLocaleString()}
                                                                        </div>
                                                                        {(negotiationScript.sources?.length ?? 0) > 0 && (
                                                            ...
                                                            ].filter((s) => typeof s.content === 'string' && s.content).map((s) => ({ ...s, content: (s.content as string).replace(/^["'"']+|["'"']+$/g, '').trim() })).map((s) => (
