...
import type { OpenAICompatibleProviderSummary } from '../../utils/modelUtils';
import {
...
const ChatPanel: React.FC<ChatPanelProps> = ({
  ...
  const modelDisplayName = getChatPanelModelDisplayName(currentModel, openAICompatibleProviders);
  ...
  return (
    <div className="flex flex-col h-full min-h-0 overflow-hidden">
      ...
      <div className={CHAT_PANEL_FOOTER_CLASS}>
        <ChatPanelAttachedScreenshots
          attachedContext={attachedContext}
          setAttachedContext={setAttachedContext}
          isLightTheme={isLightTheme}
          subtleSurfaceClass={subtleSurfaceClass}
          subtleStyle={appearance.subtleStyle}
          iconStyle={appearance.iconStyle}
          removeAllIcon={<X className="w-3.5 h-3.5" />}
          removeIcon={<X className="w-2.5 h-2.5 text-white" />}
        />
        ...
        <ChatPanelTextInput
          ...
          selectiveScreenshotShortcut={shortcuts.selectiveScreenshot}
        />
